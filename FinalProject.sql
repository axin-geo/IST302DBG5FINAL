...
select * into
G5_CusEx from
[dbo].[LI_CUSTOMERS_EXT]

--- 2.2 Create G5_CusIn table
select * into
G5_CusIn from
[dbo].[LI_CUSTOMERS_INTX]
...
alter table G5_CUSTOMERS ADD CONSTRAINT CONSTRAINT_MARITAL_STATUS CHECK (CUST_MARITAL_STATUS='single' OR  CUST_MARITAL_STATUS='married' OR CUST_MARITAL_STATUS='divorced'OR CUST_MARITAL_STATUS='separated'OR CUST_MARITAL_STATUS='widow'OR CUST_MARITAL_STATUS is null);
